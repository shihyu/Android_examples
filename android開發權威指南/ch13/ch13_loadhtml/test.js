(function() {
	var q = true, t = false, aa = window, u = undefined, ba = String, w = Math, ca = "push", ea = "cookie", x = "charAt", z = "indexOf", fa = "gaGlobal", ga = "getTime", ha = "toString", A = "window", B = "length", C = "document", D = "split", E = "location", ia = "href", F = "substring", H = "join", I = "toLowerCase";
	var ja = "_gat", ka = "_gaq", la = "4.8.9", na = "_gaUserPrefs", oa = "ioo", K = "&", L = "=", N = "__utma=", pa = "__utmb=", qa = "__utmc=", ra = "__utmk=", sa = "__utmv=", ta = "__utmz=", ua = "__utmx=", va = "GASO=";
	var wa = function() {
		var k = this, l = [], g = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_";
		k.Dc = function(m) {
			l[m] = q
		};
		k.Vb = function() {
			for ( var m = [], j = 0; j < l[B]; j++)
				if (l[j])
					m[w.floor(j / 6)] ^= 1 << j % 6;
			for (j = 0; j < m[B]; j++)
				m[j] = g[x](m[j] || 0);
	...
	var La = function(k) {
		...
		var j, p, h, a, c, i, e, d = this, r, b = k;
		d.g = new Ka(k);
		d.bb = function() {
			return u == r || r == d.L()
		};
		...
		d.I = [ [ N, d.da, d.sb, d.Gb, "." ], [ pa, d.z, d.pa, d.va, "" ],
				[ qa, d.ea, d.tb, d.Hb, "" ], [ ua, d.ga, d.ub, d.Ib, "" ],
				[ ta, d.ha, d.vb, d.xa, "." ], [ sa, d.fa, d.ra, d.wa, "." ] ]
	};
	var Ma = function() {
		var k = this;
		k.qb = function(l, g, m, j, p) {
			g[B] <= 2036 || p ? k.pb(l + "?" + g, j) : k.pb(l + "?" + m
					+ "&err=len&max=2036&len=" + g[B], j)
		};
		k.pb = function(l, g) {
			var m = new Image(1, 1);
			m.src = l;
	...
	var Na = function(k) {
		var l = this, g = k, m = new La(g), j = new Ma, p = !X.Tc(), h = function() {
		};
		l.hc = function() {
			return "https:" == P[C][E].protocol ? "https://ssl.google-analytics.com/__utm.gif"
		...
		l.C = function(a, c, i, e, d, r) {
			...
			if (n[1] < 500 || e) {
				...
				if (e || !d || n[2] >= 1) {
					...
					e = d + "e" + s;
					a = d + s
							+ (Q(f.hostname) ? "" : "&utmhn=" + T(f.hostname))
							+ (g.Q == 100 ? "" : "&utmsp=" + T(g.Q)) + a;
					if (0 == b || 2 == b) {
						f = 2 == b ? h : r || h;
						p && j.qb(g.ia, a, e, f, q)
					}
	...
	Oa.Jb = function(k, l, g, m, j, p) {
		...
		h.ua = function() {
			return "&"
					+ [ "utmt=item", "tid=" + T(h.Eb), "ipc=" + T(h.ta),
							"ipn=" + T(h.q), "iva=" + T(h.La),
							"ipr=" + T(h.jb), "iqt=" + T(h.kb) ][H]("&utm")
		}
	};
	Oa.Kb = function(k, l, g, m, j, p, h, a) {
		...
		c.ec = function(i) {
			for ( var e, d = c.N, r = 0; r < d[B]; r++)
				e = i == d[r].ta ? d[r] : e;
			return e
		};
		c.ua = function() {
			return "&"
					+ [ "utmt=tran", "id=" + T(c.p), "st=" + T(c.Ha),
							"to=" + T(c.Ab), "tx=" + T(c.yb), "sp=" + T(c.wb),
							"ci=" + T(c.Ma), "rg=" + T(c.xb), "co=" + T(c.Oa) ][H]
							("&utmt")
		}
	};
	var Pa = function(k) {
		function l() {
			var h, a, c;
			a = "ShockwaveFlash";
			var i = "$version", e = P[A].navigator;
			if ((e = e ? e.plugins : u) && e[B] > 0)
				for (h = 0; h < e[B] && !c; h++) {
					a = e[h];
					if (U(a.name, "Shockwave Flash"))
						c = a.description[D]("Shockwave Flash ")[1]
				}
			else {
				a = a + "." + a;
				try {
		...
		var g = this, m = "-", j = P[A].screen, p = P[A].navigator;
		g.ob = j ? j.width + "x" + j.height : m;
		g.nb = j ? j.colorDepth + "-bit" : m;
		g.Qb = T(P[C].characterSet ? P[C].characterSet
				: P[C].charset ? P[C].charset : m);
		g.fb = (p && p.language ? p.language
				: p && p.browserLanguage ? p.browserLanguage : m)[I]();
		g.db = p && p.javaEnabled() ? 1 : 0;
		g.Yb = k ? l() : m;
		g.Mc = function() {
			return K
					+ "utm"
					+ [ "cs=" + T(g.Qb), "sr=" + g.ob, "sc=" + g.nb,
							"ul=" + g.fb, "je=" + g.db, "fl=" + T(g.Yb) ][H]
							("&utm")
		};
		g.$b = function() {
			var h = P[A].navigator, a = P[A].history[B];
			h = h.appName + h.version + g.fb + h.platform + h.userAgent + g.db
					+ g.ob + g.nb + (P[C][ea] ? P[C][ea] : "")
					+ (P[C].referrer ? P[C].referrer : "");
			for ( var c = h[B]; a > 0;)
				h += a-- ^ c++;
			return Fa(h)
		}
	...
	var Z = function(k, l, g, m) {
		...
		h.Ya = function(a) {
			var c = h.ca();
			return new Z.s(S(a, p.Aa + L, K), S(a, p.Da + L, K), S(a, p.Fa + L,
					K), h.M(a, p.ya, "(not set)"), h.M(a, p.Ba, "(not set)"), h
					.M(a, p.Ea, c && !Q(c.G) ? Ca(c.G) : u), h.M(a, p.za, u))
		};
		h.ab = function(a) {
			var c = j(a), i;
			i = a;
				...
				for ( var d = 0; d < e[B]; d++) {
					...
					if (U(a, i.Ra[I]())) {
						...
						if (U(c, K + i.eb + L)) {
							...
							if (U(a, K))
								a = a[D](K)[0];
							return new Z.s(u, i.Ra, u, "(organic)", "organic",
									a, u)
						}
					}
				}
	...
	Z.s = function(k, l, g, m, j, p, h) {
		...
		a.Na = h;
		a.H = function() {
			var c = [], i = [ [ "cid", a.p ], [ "csr", a.R ], [ "gclid", a.W ],
					[ "ccn", a.q ], [ "cmd", a.O ], [ "ctr", a.G ],
					[ "cct", a.Na ] ], e, d;
			if (a.cb())
				for (e = 0; e < i[B]; e++)
					if (!Q(i[e][1])) {
	...
	var Ra = function() {
				...
				if (u != V) {
					...
					for (G = 0; G < V[B]; G++)
						if (u != V[G]) {
							...
							var R;
							R = V[G];
							var ma = "", Y = void 0, da = void 0, Da = void 0;
							for (Y = 0; Y < R[B]; Y++) {
								da = R[x](Y);
								Da = n[da];
								ma += u != Da ? Da : da
		...
		var j = this, p = za(j), h = {}, a = "k", c = "v", i = [ a, c ], e = "(", d = ")", r = "*", b = "!", f = "'", n = {};
		n[f] = "'0";
		n[d] = "'1";
		n[r] = "'2";
		n[b] = "'3";
		...
		j.sa = p("_setValue", 90, function(o, v, y) {
			if (typeof y != "number" && (u == Number || !(y instanceof Number))
					|| w.round(y) != y || y == NaN || y == Infinity)
				return t;
			k(o, c, v, y[ha]());
			return q
		});
	...
	var Ta = function(k, l) {
		var g = this, m = P[A].external, j = P[A].webkitPerformance, p = 10;
		g.gb = new Ra;
		g.gc = function() {
			var h, a = "timing", c = "onloadT";
			if (m && m[c] != u && m.isValidLoadTime)
				h = m[c];
			else if (j && j[a])
				h = j[a].loadEventStart - j[a].navigationStart;
			return h
		};
		g.Kc = function() {
		...
		g.Cb = function() {
			...
			if (P[A].top != P[A])
				return t;
			if (g.zb()) {
				var h = P[A], a = "load", c = g.zb;
				if (h.addEventListener)
					h.addEventListener(a, c, t);
				else
					h.attachEvent && h.attachEvent("on" + a, c)
			}
			return q
		}
	};
	...
	$.Xb = function(k) {
		var l = "gaso=", g = P[C][E].hash;
		if (g && 1 == g[z](l))
			k = S(g, l, K);
		else
			k = (g = P[A].name) && 0 <= g[z](l) ? S(g, l, K)
					: S(k.h(), va, ";");
		return k
	};
	$.wc = function(k, l) {
		var g = (l || "www") + ".google.com";
		g = "https://" + g + "/analytics/reporting/overlay_js?gaso=" + k + K
				+ Ga();
		var m = "_gasojs", j = P[C].createElement("script");
		j.type = "text/javascript";
		j.src = g;
		if (m)
			j.id = m;
		(P[C].getElementsByTagName("head")[0] || P[C]
				.getElementsByTagName("body")[0]).appendChild(j)
	};
	$.load = function(k, l) {
		if (!$.tc) {
			var g = $.Xb(l), m = g
	...
	var Ua = function(k, l, g) {
		...
		function j() {
			m();
			var b = e.b, f = b[z]("www.google.") * b[z](".google.")
					* b[z]("google.");
		...
		var a = this, c = za(a), i = u, e = new Ja, d = t, r = u;
		a.q = k;
		...
		a.oa = function(b) {
			...
			f += "&utmhid=" + n + "&utmr=" + T(ba(a.aa)) + "&utmp="
					+ T(a.Ac(b));
			return f
		};
		a.Ac = function(b) {
			var f = P[C][E];
			b && O(13);
			return b = u != b && "" != b ? T(b, q)
					: T(f.pathname + f.search, q)
		};
		a.Qc = function(b) {
			if (a.F()) {
				var f = "";
		...
		a.pc = function() {
			var b = a.r, f = a.j, n = f.h(), s = a.a + "", o = P[A] ? P[A][fa]
					: u, v, y = U(n, N + s + "."), M = U(n, pa + s), V = U(n,
					qa + s), J, G = [], R = "", ma = t;
			n = Q(n) ? "" : n;
			if (e.w) {
		...
		a.Pc = function() {
			...
			if (Ga() % 1E3 === 42)
				try {
					if (b.external && b.external.onloadT != u
							|| b.webkitPerformance
							&& b.webkitPerformance.timing)
						O(12)
				} catch (f) {
				}
		};
		...
		a.he = c(
				...
				function() {
					...
					b = P[C].getElementById ? P[C].getElementById("utmtrans")
							: P[C].utmform && P[C].utmform.utmtrans ? P[C].utmform.utmtrans
									: u;
					a.c();
					if (b && b.value) {
						a.d = new Oa;
						...
						for (b = 0; b < s[B]; b++) {
							...
							for (n = 0; n < f[B]; n++)
								f[n] = Ea(f[n]);
							if ("T" == f[0])
								a.Ga(f[1], f[2], f[3], f[4], f[5], f[6], f[7],
										f[8]);
							else
								"I" == f[0]
										&& a.Lb(f[1], f[2], f[3], f[4], f[5],
												f[6])
						}
					}
				});
		...
		a.dd = c("_clearXValue", 73, function(b) {
			a.e.V(b)
		});
		...
		a.Bb = c("_trackEvent", 4, function(b, f, n, s) {
			...
			if (u != b && u != f && "" != b && "" != f) {
				o.t(5);
				o.V(5);
				(b = o.k(5, 1, b) && o.k(5, 2, f) && (u == n || o.k(5, 3, n))
						&& (u == s || o.sa(5, 1, s)))
						&& a.Cc(o)
			} else
				b = t;
		...
		a.Ic = c("_setSessionCookieTimeout", 26, function(b) {
			e.rb = b
		});
	...
	var Xa = function() {
		...
		k.push = function() {
			O(5);
			for ( var g = arguments, m = 0, j = 0; j < g[B]; j++)
				try {
					if (typeof g[j] === "function")
						g[j]();
					else {
						var p = "", h = g[j][0], a = h.lastIndexOf(".");
						if (a > 0) {
							p = h[F](0, a);
							h = h[F](a + 1)
						}
	...
	var X = new Va;
	var Ya = aa[ja];
	if (Ya && typeof Ya._getTracker == "function")
		X = Ya;
	else
		aa[ja] = X;
	var Wa = new Xa;

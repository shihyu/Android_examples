package mobile.android.ch11.invoke.content.provider;
...
public class Main extends Activity
{
	...
	public void onClick_Show_Cities(View view)
	{
		...
		Uri uri = Uri
				.parse("content://mobile.android.ch11.regioncontentprovider/cities");
		...
		uri = Uri
				.parse("content://mobile.android.ch11.regioncontentprovider/name/Ân¶§");
		cursor = contentResolver.query(uri, null, null, null, null);
		if (cursor.moveToFirst())
		{
			Toast.makeText(
	...
	public void onClick_Show_Lining_Cities(View view)
	{
		ContentResolver contentResolver = getContentResolver();
		Uri uri = Uri
				.parse("content://mobile.android.ch11.regioncontentprovider/cities_in_province/¿ñ¹ç");
		Cursor cursor = contentResolver.query(uri, new String[]

...
public class Main extends Activity
{
	...
	public void onClick_Jar_Compress(View view)
	{
		try
		{
			...
			jos.closeEntry();
			jos.close();
			Toast.makeText(this, "成功將strings.xml檔案以jar格式壓縮.", Toast.LENGTH_LONG)
					.show();
	...
	public void onClick_Jar_Uncompress(View view)
	{
		try
		{
			...
			{
				Toast.makeText(this, "壓縮檔案不存在.", Toast.LENGTH_LONG).show();
				return;
			}
			...
			Toast.makeText(this, "成功解壓jar格式的檔案.", Toast.LENGTH_LONG).show();
	...
	public void onClick_Zip_Compress(View view)
	{
		try
		{
			...
			zos.finish();
			zos.close();
			Toast.makeText(this, "成功將main.xml、strings.xml檔案以zip格式壓縮.",

...
public class Main extends Activity
{
	...
	public void onClick_TopDialog(View view)
	{
		AlertDialog alertDialog = new AlertDialog.Builder(this)
				.setMessage("在頂端顯示交談視窗").setPositiveButton("確定", null).create();
	...
	{
		AlertDialog alertDialog = new AlertDialog.Builder(this).setMessage("在底端顯示交談視窗")
	...
	{
		AlertDialog alertDialog = new AlertDialog.Builder(this).setMessage("在任意位置顯示交談視窗")
				.setPositiveButton("確定", null).create();
		Window window = alertDialog.getWindow();

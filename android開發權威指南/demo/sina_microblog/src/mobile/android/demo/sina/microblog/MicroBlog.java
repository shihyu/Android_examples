		...
		OnItemLongClickListener
{
			...
			ContextMenuInfo menuInfo)
	{
		...
		if (mCurrentPosition < adapter.getStatusCount())
		{
			...
			// CONTEXT_MENUITEM_REFRESH_PHOTO, 4, "更新頭像");
	...
	public boolean onMenuItemClick(MenuItem item)
	{
		...
		switch (item.getItemId())
		{
			...
			case CONTEXT_MENUITEM_SHOW_BIGPICTURE:
				...
				mProgressDialog = mUtil.showSpinnerProgressDialog("正在下載大圖...");
	...
	class LoginOnClick implements OnClickListener
	{
		...
		public void onClick(View view)
		{
			...
			try
			{
				...
				mProgressDialog = mUtil.showSpinnerProgressDialog("正在登入...");
					...
					try
					{
						...
						if (minStatusId > 0)
						{
							...
							progressDialog = mUtil
									.showSpinnerProgressDialog("正在獲得更多微博...");
			...
			MicroBlogAdapter microBlogAdapter)
	{
		...
		{
			mProgressDialog = mUtil.showSpinnerProgressDialog("正在獲得微博...");
	...
	private void refreshMicroBlog()
	{
		...
		try
		{
			...
			if (maxStatusId < Long.MAX_VALUE)
			{
				...
				paging.setCount(20);
				progressDialog = mUtil.showSpinnerProgressDialog("正在更新微博...");

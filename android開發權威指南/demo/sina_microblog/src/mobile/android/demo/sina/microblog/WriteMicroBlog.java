		...
		OnClickListener, TextWatcher, OnMenuItemClickListener, Const
{
	...
	private Handler mHandler = new Handler()
	{
		...
		public void handleMessage(Message msg)
		{
			...
			{
				case 1:
					Util.showMsg(WriteMicroBlog.this, "發佈成功.");
				...
				default:
					...
					Util.showMsg(WriteMicroBlog.this, "發佈失敗.");
					break;
			}
		}
	...
	public void onTextChanged(CharSequence s, int start, int before, int count)
	{
		...
		{
			mtvRemainWordCount.setText("可輸入字數：" + remainWordCount);
		...
		else
		{
			...
			mtvRemainWordCount.setText("超出字數：" + remainWordCount);
